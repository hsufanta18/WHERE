...
public class Toilet extends AppCompatActivity implements OnMapReadyCallback, Overlay.OnClickListener {
    ...
    String[] str_toilet_name = new String[35000]; //주차장 명
    String[] str_latitude = new String[35000]; //주차장 위도
    String[] str_longtitude = new String[35000]; //주차장 경도
    String[] str_address = new String[35000]; //소재지 주소
    String[] str_telnum = new String[35000]; //전화번호
    ...
    double std_lat, std_lon; // 현재 위치 위도 경도
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        std_lat = Math.round(loc_Current.getLatitude() * 1000000) / 1000000.0;
        std_lon = Math.round(loc_Current.getLongitude() * 1000000) / 1000000.0;
        ...
        Spinner spinner2 = findViewById(R.id.distance_option); //무료,유료 구분하여 선택가능하도록 설정
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                UpdateMarkers(latlng.latitude, latlng.longitude, db_distance);
            }
        });
    ...
    public void onMapReady(@NonNull NaverMap naverMap) {
        ...
        InfoWindow.setAdapter(new InfoWindow.DefaultViewAdapter(this) {
            ...
            protected View getContentView(@NonNull InfoWindow infoWindow) {
                ...
                money.setText("주소 :" + str_address[SearchMarkerIndex]);
                return view;
            }
        });
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                switch (eventType) {
                    ...
                    case XmlPullParser.START_TAG:
                        ...
                        if (tag.equals("item")) ;
                        else if (tag.equals("toiletNm")) { //주차장 명
                            xpp.next();
                            str_toilet_name[count] = xpp.getText();
                        } else if (tag.equals("rdnmadr")) { //주차장 명
                            xpp.next();
                            str_address[count] = xpp.getText();
                        } else if (tag.equals("phoneNumber")) { //주차장 명
                            xpp.next();
                            str_telnum[count] = xpp.getText();
                        } else if (tag.equals("latitude")) { //주차장 명
                            xpp.next();
                            str_latitude[count] = xpp.getText();
                        } else if (tag.equals("longitude")) { //주차장 명
                            xpp.next();
    ...
    public class MyAsyncTask extends AsyncTask<Void, Integer, Boolean> {
        ...
        protected void onPostExecute(Boolean s) {// 초기 무료 마커 설정
            ...
            UpdateMarkers(std_lat, std_lon, 5.0);
    ...
    public void UpdateMarkers(double lat, double lon, double distance) {// 무료,유료 마커 설정
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (str_toilet_name[i] == null || str_longtitude[i] == null || str_latitude[i] == null || str_address[i] == null|| str_telnum[i] == null) {
                continue;
            }

            if(distance_calculator.getDistance(lat, lon, Double.parseDouble(str_latitude[i]), Double.parseDouble(str_longtitude[i])) >= distance)
                continue;
